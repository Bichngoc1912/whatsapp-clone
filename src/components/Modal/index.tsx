      ...
      >
        <Box sx={{...style, ':focus-visible': { borderColor: '#0891B2'}}}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            Hi, Hề lô hế lô, chat với mình hoặc bất kì ai, nhưng mà người đó phải login dô nhe, không login là tui chịu thua á 🥺🥺 
            Tâm hự thầm kín dí tui khum, email tui nà: <b style={{ color: '#0891B2'}}>ngocntbnctk40@gmail.com</b>
          </Typography>
        </Box>
      </Modal>
    </div>
